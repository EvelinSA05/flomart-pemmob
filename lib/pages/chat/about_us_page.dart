...
class _AboutUsPageState extends State<AboutUsPage> {
  int _currentIndex = 4; // "Tentang Kami" tab selected
  ...
  Widget _buildAppBar() {
    return Container(
      ...
      child: Row(
        children: [
          // FLOMART Logo image matching Figma
          Image.asset(
            'assets/images/flomart_logo.png',
            height: 70,
          ),
          const Spacer(),
          ...
          GestureDetector(
            ...
            child: _appBarIcon(Icons.chat_bubble, size: 20),
          ),
          const SizedBox(width: 12),
          _appBarIcon(Icons.phone, size: 20),
          const SizedBox(width: 12),
          _appBarIcon(Icons.notifications, size: 20),
          const SizedBox(width: 12),
          _appBarIcon(Icons.shopping_bag, size: 20),
          const SizedBox(width: 12),
          _appBarIcon(Icons.person, size: 20),
        ],
      ),
    );
  }

  Widget _appBarIcon(IconData icon, {double size = 22}) {
    return Icon(icon, size: size, color: const Color(0xFF2E7D32));
  }
            ...
            children: [
              ...
              Expanded(
                ...
                child: ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/LatarBelakang.png',
                    fit: BoxFit.cover,
                    height: 120,
                  ),
                ),
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              _benihCard(
                iconAsset: 'assets/images/BestPlanIcon.png',
              ...
              const SizedBox(width: 12),
              _benihCard(
                iconAsset: 'assets/images/LogistikIcon.png',
                title: 'Pengiriman Aman',
                description:
                    'Pengiriman aman menjaga kualitas\ntanaman',
              ),
              const SizedBox(width: 12),
              _benihCard(
                iconAsset: 'assets/images/TerjaminIcon.png',
                title: 'Kualitas Terjamin',
                description:
                    'Produk tanaman berkualitas dan\nterpercaya',
              ),
            ],
          ),
        ],
